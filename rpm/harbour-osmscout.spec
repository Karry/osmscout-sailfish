...
rm %{buildroot}%{_includedir}/osmscout/*/*.h
# remove desktop qml
rm %{buildroot}%{_datadir}/harbour-osmscout/qml/desktop.qml

## Jolla harbour rules:

# -- ship all shared unallowed libraries with the app
mkdir -p %{buildroot}%{_datadir}/harbour-osmscout/lib

# << install post

# -- check app rpath to find its libs
chrpath -l %{buildroot}%{_bindir}/harbour-osmscout
ls -al     %{buildroot}%{_bindir}/harbour-osmscout
sha1sum    %{buildroot}%{_bindir}/harbour-osmscout

%files
%defattr(-,root,root,-)
%{_bindir}
%{_datadir}/harbour-osmscout
%{_datadir}/harbour-osmscout/lib/
%{_datadir}/applications/harbour-osmscout.desktop
%{_datadir}/harbour-osmscout/map-styles/
%{_datadir}/harbour-osmscout/map-icons/
%{_datadir}/icons/hicolor/86x86/apps/harbour-osmscout.png
%{_datadir}/icons/hicolor/108x108/apps/harbour-osmscout.png
%{_datadir}/icons/hicolor/128x128/apps/harbour-osmscout.png
%{_datadir}/icons/hicolor/172x172/apps/harbour-osmscout.png
